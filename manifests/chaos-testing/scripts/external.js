...
const profiles = {
  ...
  load: {
    stages: [
      { duration: '3m', target: 2500 }, // Start with 1000 users
      { duration: '15m', target: 2500 }, // Stay at 1000 users
  ...
  soak: {
    stages: [
      { duration: '5m', target: 3000 }, // Start with 2000 users
      { duration: '3h', target: 3000 }, // Hold for 3 hours
